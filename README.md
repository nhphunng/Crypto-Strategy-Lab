...
| Database features 003–005 | `backend/migrations/` | Đã có schema cho Strategy, Backtest/Evaluation và Leaderboard |
...
| Web frontend | `frontend/` | Giao diện React prototype đã được hợp nhất vào frontend chính; các màn hình ngoài Leaderboard vẫn dùng adapter dữ liệu mô phỏng |
...
Tổng theo năm feature chính: **112/279 task, khoảng 40%**. Tỷ lệ này chỉ thể hiện số checkbox, không phải phần trăm effort vì độ lớn mỗi task khác nhau.
